...
class Individual:
	...
	def __eq__(self, other):
		...
		return self.chromosomes[0] == other.chromosomes[0]
	...
	def __hash__(self):
		...
		return hash(self.chromosomes[0])


		#return self.subsample_hash(self.chromosomes[0][0]) + self.subsample_hash(self.chromosomes[0][1]) 
